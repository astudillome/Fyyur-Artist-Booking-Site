...
def venues():
    ...
    area_data = db.session.query(Venue.city, Venue.state).distinct(Venue.city, Venue.state).order_by('state').all()
    data = []
...
def create_show_submission():
    ...
    try:
      ...
      show = Show(artist_id=artist_id, artist_name=artist_name,artist_image_link=artist_image_link, venue_id=venue_id, venue_name=venue_name, start_time=start_time)
